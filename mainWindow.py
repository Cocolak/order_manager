...
"}\n")
        ...
        self.homePageButton = QtWidgets.QPushButton(self.topWidget)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/home.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.homePageButton.setIcon(icon)
        self.homePageButton.setMinimumSize(QtCore.QSize(50,30))
        self.homePageButton.clicked.connect(self.homePageClicked)
